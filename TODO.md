# TODO for Kochi Rent Direct Redesign

- [x] Update data.json: Add "image" field to existing properties with placeholder URLs. Add more properties for additional local places (e.g., Vyttila, Fort Kochi, Kalamassery, MG Road, Palarivattom).
